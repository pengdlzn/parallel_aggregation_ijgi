...
%This is different from earlier implementation, where the compatibility of neighbours was defined based on *both* the length of the common boundary and the class of the neighbouring polygon. Here, we could also involve the compactness of the result into the equation for deciding which neighbour is best (iff important that we want compact regions)
