...
That is, an area on map becomes a polyhedron in the SSC.
...
The common boundary of the two areas is a vertical wall 
for the normal tGAP in the SSC.
While in the SSC for the smooth tGAP, 
...
\fig\ref{fig:event_and_step}a by processing a merging step with one event.
\fig\ref{fig:event_and_step}d is obtained from 
\fig\ref{fig:event_and_step}c by processing a merging step with two events.
...
Consequently, we parallelly merge all the pairs of areas for the events,
