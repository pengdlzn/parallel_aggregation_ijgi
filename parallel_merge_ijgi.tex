...
%We define that a merging event consists of 
...
\citet[\fig5.9b]{Meijers2011Thesis} designed a face table 
...
we see that the step\_high values of faces~1 and~2 change form~1 to~2
(the new values are in bold).
We also see that the step\_low value of faces~7 changes form~1 to~2.
...
%
\parbox{.49\linewidth}{
\captionof{table}{face table of the merging sequence 
    without parallel events,
    corresponding to sequence~I of \fig\ref{fig:face_tgap}.
}
\label{tab:face_tgap}
\centering
\begin{tabular}{ccc}
...
%
\parbox{.49\linewidth}{
\captionof{table}{face table of the merging sequence with parallel events,
    corresponding to sequence~II of \fig\ref{fig:face_tgap}.
}
...
Our case study shows the effective of our approach.
