...
(\eg~from \fig\ref{fig:intro}a to \fig\ref{fig:intro}b), 
...
\caption{The SSC of the strategy of
map generalization with gradual changes (see \fig\ref{fig:intro}).
