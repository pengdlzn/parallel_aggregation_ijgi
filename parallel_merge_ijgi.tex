...
%If several faces have the same state\_high values,
%then the merging expansions of these faces finish at the same state.
%Those expansions also start at the same state 
