...
Often, a multi-representation database is used to store
maps at different scales and to send proper data to clients on request
\citep[\eg][]{Hampe2004multiple}.
However, large discrete changes between different map representation
may confuse users,
...
where, at each step, a single parcel will be merged into
