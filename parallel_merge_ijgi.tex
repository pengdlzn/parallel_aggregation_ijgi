...
This paper used a greedy algorithm to find parallel merging events
for each step.
...
which can be realized by using the method of 
\citet{Meijers2011LineSimp}.
